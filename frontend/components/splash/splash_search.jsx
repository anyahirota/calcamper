...
class SplashSearch extends React.Component {
    ...
    parkSearchDropdown() {
        ...
        if (parkList.length < 1) {
            return (
                <div className="park-search-list-container" id="splash-search-list-container">
    ...
    render() {
        ...
        const defaultTextStyles = this.state.defaultText === this.state.searchInput ? "defaultTextSplash" : "";

        return (
            <div className="splash-search-bar-container">
                <form onSubmit={this.handleSubmit} className="splash-search-bar">
                    <div className="splash-search-bar-input">
                    ...
                    <input className="splash-search-bar-button" type="submit" value="Search"/>
